...
/* @test
 * @bug 5067405
 * @summary Appendable.Basic test for classes which implement Appendable.
 */
...
public class Basic {
	...
	private static BasicRunnable testStringBuilderTC =
			new BasicRunnable() {
				private String csn, exp;
				private StringBuilderTC sb;
				public void init(Appendable sb, String csn, String exp) {
					this.sb = (StringBuilderTC)sb;
					this.csn = csn;
					this.exp = exp;
				}
				public void run() {
					ck("StringBuilderTC.append(" + csn + ")", exp, sb.toString());
				}
				public Appendable reset(Appendable sb) {
	...
	public static void main(String [] args) throws Exception {
		...
		for (int i = 0; i < ca.length; i++) {
			...
			test(new StringBuilderTC(), a, testStringBuilderTC);
		}
