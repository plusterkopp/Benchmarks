...
public class BuilderForwarding {
    ...
    public void appendCharSequence() {
        ...
        CharSequence aStringBuilder = new StringBuilderTC(A_STRING_BUILDER_VAL);
        CharSequence aStringBuffer = new StringBuffer(A_STRING_BUFFER_VAL);

        assertEquals( /*actual*/ new StringBuilderTC().append(aString).toString(), /*expected*/ A_STRING_VAL );
        assertEquals( new StringBuilderTC().append(aStringBuilder).toString(), A_STRING_BUILDER_VAL );
        assertEquals( new StringBuilderTC().append(aStringBuffer).toString(), A_STRING_BUFFER_VAL );

        assertEquals( /*actual*/ new StringBuilderTC(NON_EMPTY_VAL).append(aString).toString(), NON_EMPTY_VAL+A_STRING_VAL );
        assertEquals( new StringBuilderTC(NON_EMPTY_VAL).append(aStringBuilder).toString(), NON_EMPTY_VAL+A_STRING_BUILDER_VAL );
        assertEquals( new StringBuilderTC(NON_EMPTY_VAL).append(aStringBuffer).toString(), NON_EMPTY_VAL+A_STRING_BUFFER_VAL );
    }
    ...
    public void insertintboolean() {
        boolean b = true;
	    StringBuilderTC sb = new StringBuilderTC("012345");
    ...
    public void insertintCharSequence() {
        ...
        assertEquals( new StringBuilderTC(initString).insert(2, aString).toString(), "01"+A_STRING_VAL+"2345" );

        assertEquals( new StringBuilderTC(initString).insert(2, aStringBuilder).toString(), "01"+A_STRING_BUILDER_VAL+"2345" );

        assertEquals( new StringBuilderTC(initString).insert(2, aStringBuffer).toString(), "01"+A_STRING_BUFFER_VAL+"2345" );

        try {
            new StringBuilderTC(initString).insert(7, aString);
    ...
    public void lastIndexOfString() {
	    ...
	    StringBuilderTC sb = new StringBuilderTC(xyz3);
    ...
    public void lastIndexOfStringint() {
	    StringBuilderTC sb = new StringBuilderTC("xyzxyzxyz");
