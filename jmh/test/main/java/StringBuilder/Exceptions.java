...
//          x.printStackTrace();
    ...
    public static void main(String [] args) {
        System.out.println("StringBuilderTC()");
        tryCatch("  no args", null, new Runnable() {
                public void run() {
                    new StringBuilderTC();
                }});

        System.out.println("StringBuilderTC(int length)");
        tryCatch("  1", null, new Runnable() {
                public void run() {
                    new StringBuilderTC(1);
                }});
        ...
        System.out.println("StringBuilderTC(String str)");
        tryCatch("  null", new NullPointerException(), new Runnable() {
                public void run() {
                    new StringBuilderTC(null);
                }});
        tryCatch("  foo", null, new Runnable() {
                public void run() {
                    new StringBuilderTC("foo");
                }});

//        System.out.println("StringBuilderTC.replace(int start, int end, String str)");
//        tryCatch("  -1, 2, \" \"",
//                 new StringIndexOutOfBoundsException("start -1, end 2, length 7"),
//                 new Runnable() {
//                public void run() {
//                    StringBuilderTC sb = new StringBuilderTC("hilbert");
//                    sb.replace(-1, 2, " ");
//                }});
//        tryCatch("  7, 8, \" \"",
...
//                 new Runnable() {
//                public void run() {
//                    StringBuilderTC sb = new StringBuilderTC("banach");
//                    sb.replace(7, 8, " ");
//                }});
//        tryCatch("  2, 1, \" \"",
...
//                 new Runnable() {
//                public void run() {
//                    StringBuilderTC sb = new StringBuilderTC("riemann");
//                    sb.replace(2, 1, " ");
//                }});
