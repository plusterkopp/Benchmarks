...
//            StringBuilderTC sb = new StringBuilderTC(input[i]);
//
//            /*
//             * Normal case
//             */
...
//    }
    ...
    static void test3() {
        for (int i = 0; i < input.length; i++) {
            StringBuilderTC sb = new StringBuilderTC(input[i]).reverse();
        ...
        for (int i = 0; i < testdata1.length; i++) {
            StringBuilderTC sb = new StringBuilderTC(testdata1[i][0]).reverse();
...
//                c = s.codePointAt(j);
//                StringBuilderTC rsb = sb.appendCodePoint(c);
...
//        for (int i = 0; i < input.length; i++) {
//            String s = input[i];
//            StringBuilderTC sb = new StringBuilderTC(s);
...
//    static void testCodePoint(boolean isAt, StringBuilderTC sb, int index, int expected) {
...
//    static void testCodePoint(boolean isAt, StringBuilderTC sb, int index) {
...
//        try {
//            new StringBuilderTC().appendCodePoint(codePoint);
//        } catch (Exception e) {
...
//    static void testCodePointCount(StringBuilderTC sb, int beginIndex, int endIndex,
...
//    static void testOffsetByCodePoints(StringBuilderTC sb, int index, int offset,
//                                       Class expectedException) {
//        try {
...
//    }
    ...
    static void check(boolean err, String s, StringBuilderTC got, String expected) {
        if (err) {
            throw new RuntimeException("Error: " + s
                                       + " returned an unexpected value. got <"
