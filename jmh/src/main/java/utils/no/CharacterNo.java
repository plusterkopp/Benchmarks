...
/**
 * The {@code CharacterNo} class wraps a value of the primitive
 * type {@code char} in an object. An object of type
 * {@code CharacterNo} contains a single field whose type is
 * {@code char}.
 * <p>
 ...
 * <p>
 * CharacterNo information is based on the Unicode Standard, version 6.2.0.
 * <p>
 * The methods and data of class {@code CharacterNo} are defined by
 * the information in the <i>UnicodeData</i> file that is part of the
 * Unicode CharacterNo Database maintained by the Unicode
 ...
 * </ul>
 *
 * <h3><a name="unicode">Unicode CharacterNo Representations</a></h3>
 *
 * <p>The {@code char} data type (and therefore the value that a
 * {@code CharacterNo} object encapsulates) are based on the
 ...
 * {@code CharacterNo.isLetter('\u005CuD840')} returns {@code false}, even though
 * this specific value if followed by any low-surrogate value in a string
 * would represent a letter.
 *
 * <li>The methods that accept an {@code int} value support all
 * Unicode characters, including supplementary characters. For
 * example, {@code CharacterNo.isLetter(0x2F81A)} returns
 ...
 */
public final
class CharacterNo implements java.io.Serializable, Comparable<CharacterNo> {
    /**
     ...
     *
     * @see     CharacterNo#digit(char, int)
     * @see     CharacterNo#forDigit(int, int)
    ...
    public static final Class<CharacterNo> TYPE = (Class<CharacterNo>) Class.getPrimitiveClass("char");
     ...
     * {@code CharacterNo} class is {@link CharacterNo.UnicodeBlock}.
     ...
     * Unicode specification. CharacterNo blocks generally define characters
    ...
    public static final class UnicodeBlock extends Subset {
        ...
        /**
         * Constant for the "Optical CharacterNo Recognition" Unicode character block.
         * @since 1.2
         */
        ...
        private static final int blockStarts[] = {
                ...
                0x2440,   // 2440..245F; Optical CharacterNo Recognition
         ...
         * <a href="CharacterNo.html#supplementary"> supplementary
         ...
         * @see CharacterNo#isValidCodePoint(int)
         * @since   1.5
         */
         ...
         * version of the standard. The {@link CharacterNo} class specifies
     ...
     * script, such as {@link CharacterNo.UnicodeScript#LATIN Latin}, or
     * one of the following three special values,
     * {@link CharacterNo.UnicodeScript#INHERITED Inherited},
     * {@link CharacterNo.UnicodeScript#COMMON Common} or
     * {@link CharacterNo.UnicodeScript#UNKNOWN Unknown}.
     *
     * @since 1.7
     */
    public static enum UnicodeScript {
        ...
        private static HashMap<String, CharacterNo.UnicodeScript> aliases;
        static {
         ...
         * standard. The {@link CharacterNo} class specifies the version of
         * the standard that it supports.
         * <p>
         * CharacterNo case is ignored for all of the valid script names.
    ...
    /**
     * The value of the {@code CharacterNo}.
     *
     * @serial
     */
    ...
    /**
     * Constructs a newly allocated {@code CharacterNo} object that
     * represents the specified {@code char} value.
     *
     * @param  value   the value to be represented by the
     *                  {@code CharacterNo} object.
     */
    public CharacterNo(char value) {
        this.value = value;
    }
    ...
    private static class CharacterCache {
        ...
        static final CharacterNo cache[] = new CharacterNo[127 + 1];

        static {
            for (int i = 0; i < cache.length; i++)
                cache[i] = new CharacterNo((char)i);
        }
    }

    /**
     * Returns a <tt>CharacterNo</tt> instance representing the specified
     * <tt>char</tt> value.
     * If a new <tt>CharacterNo</tt> instance is not required, this method
     * should generally be used in preference to the constructor
     * {@link #CharacterNo(char)}, as this method is likely to yield
     ...
     * @return a <tt>CharacterNo</tt> instance representing <tt>c</tt>.
     * @since  1.5
     */
    public static CharacterNo valueOf(char c) {
        if (c <= 127) { // must cache
            return CharacterCache.cache[(int)c];
        }
        return new CharacterNo(c);
    }

    /**
     * Returns the value of this {@code CharacterNo} object.
    ...
    /**
     * Returns a hash code for this {@code CharacterNo}; equal to the result
     * of invoking {@code charValue()}.
     *
     * @return a hash code value for this {@code CharacterNo}
     */
    @Override
    public int hashCode() {
        return CharacterNo.hashCode(value);
    }

    /**
     * Returns a hash code for a {@code char} value; compatible with
     * {@code CharacterNo.hashCode()}.
     *
     * @since 1.8
     *
     ...
     * {@code null} and is a {@code CharacterNo} object that
    ...
    public boolean equals(Object obj) {
        if (obj instanceof CharacterNo) {
            return value == ((CharacterNo)obj).charValue();
        }
        return false;
    }
     ...
     * {@code CharacterNo}'s value.  The result is a string of
     ...
     *         {@code false} otherwise.
     * @see    CharacterNo#isLowSurrogate(char)
     * @see    CharacterNo.UnicodeBlock#of(int)
     * @since  1.5
     */
     ...
     *         {@code false} otherwise.
     * @see    CharacterNo#isHighSurrogate(char)
     * @since  1.5
     */
     ...
     * @see     CharacterNo#isSupplementaryCodePoint(int)
     * @since   1.5
     */
     ...
     * is not a
     * <a href="CharacterNo.html#supplementary">supplementary character</a>,
     ...
     * by {@code CharacterNo.getType(ch)}, is
     ...
     *          {@code false} otherwise.
     * @see     CharacterNo#isLowerCase(char)
     * @see     CharacterNo#isTitleCase(char)
     * @see     CharacterNo#toLowerCase(char)
     * @see     CharacterNo#getType(char)
     */
     ...
     * <p>
     * A character is lowercase if its general category type, provided
     * by {@link CharacterNo#getType getType(codePoint)}, is
     * {@code LOWERCASE_LETTER}, or it has contributory property
     * Other_Lowercase as defined by the Unicode Standard.
     * <p>
     * The following are examples of lowercase characters:
     ...
     * @return  {@code true} if the character is lowercase;
     *          {@code false} otherwise.
     * @see     CharacterNo#isLowerCase(int)
     * @see     CharacterNo#isTitleCase(int)
     * @see     CharacterNo#toLowerCase(int)
     * @see     CharacterNo#getType(int)
     * @since   1.5
     */
    public static boolean isLowerCase(int codePoint) {
        return getType(codePoint) == CharacterNo.LOWERCASE_LETTER ||
     ...
     * {@code CharacterNo.getType(ch)}, is {@code UPPERCASE_LETTER}.
     ...
     * @see     CharacterNo#isLowerCase(char)
     * @see     CharacterNo#isTitleCase(char)
     * @see     CharacterNo#toUpperCase(char)
     * @see     CharacterNo#getType(char)
     * @since   1.0
     */
     ...
     * <p>
     * A character is uppercase if its general category type, provided by
     * {@link CharacterNo#getType(int) getType(codePoint)}, is {@code UPPERCASE_LETTER},
     * or it has contributory property Other_Uppercase as defined by the Unicode Standard.
     * <p>
     * The following are examples of uppercase characters:
     * <blockquote><pre>
     ...
     * @see     CharacterNo#isLowerCase(int)
     * @see     CharacterNo#isTitleCase(int)
     * @see     CharacterNo#toUpperCase(int)
     * @see     CharacterNo#getType(int)
     * @since   1.5
     */
    public static boolean isUpperCase(int codePoint) {
        return getType(codePoint) == CharacterNo.UPPERCASE_LETTER ||
     ...
     * category type, provided by {@code CharacterNo.getType(ch)},
     ...
     *          {@code false} otherwise.
     * @see     CharacterNo#isLowerCase(char)
     * @see     CharacterNo#isUpperCase(char)
     * @see     CharacterNo#toTitleCase(char)
     * @see     CharacterNo#getType(char)
     * @since   1.0.2
     */
     ...
     * <p>
     * A character is a titlecase character if its general
     * category type, provided by {@link CharacterNo#getType(int) getType(codePoint)},
     * is {@code TITLECASE_LETTER}.
     * <p>
     * Some characters look like pairs of Latin letters. For example, there
     * is an uppercase letter that looks like "LJ" and has a corresponding
     ...
     *          {@code false} otherwise.
     * @see     CharacterNo#isLowerCase(int)
     * @see     CharacterNo#isUpperCase(int)
     * @see     CharacterNo#toTitleCase(int)
     * @see     CharacterNo#getType(int)
     * @since   1.5
     */
    public static boolean isTitleCase(int codePoint) {
        return getType(codePoint) == CharacterNo.TITLECASE_LETTER;
    }
     ...
     * <p>
     * A character is a digit if its general category type, provided
     * by {@link CharacterNo#getType(int) getType(codePoint)}, is
     * {@code DECIMAL_DIGIT_NUMBER}.
     * <p>
     * Some Unicode character ranges that contain digits:
     * <ul>
    ...
    public static boolean isDigit(int codePoint) {
        return getType(codePoint) == CharacterNo.DECIMAL_DIGIT_NUMBER;
    }
     ...
     * @see     CharacterNo#isDigit(char)
     * @see     CharacterNo#isLetter(char)
     * @see     CharacterNo#isLetterOrDigit(char)
     * @see     CharacterNo#isLowerCase(char)
     * @see     CharacterNo#isTitleCase(char)
     * @see     CharacterNo#isUpperCase(char)
     * @since   1.0.2
     ...
     * @return  {@code true} if the character has a defined meaning
     *          in Unicode; {@code false} otherwise.
     * @see     CharacterNo#isDigit(int)
     * @see     CharacterNo#isLetter(int)
     * @see     CharacterNo#isLetterOrDigit(int)
     * @see     CharacterNo#isLowerCase(int)
     * @see     CharacterNo#isTitleCase(int)
     * @see     CharacterNo#isUpperCase(int)
     * @since   1.5
    ...
    public static boolean isDefined(int codePoint) {
        return getType(codePoint) != CharacterNo.UNASSIGNED;
    }
     ...
     *          {@code false} otherwise.
     * @see     CharacterNo#isDigit(char)
     * @see     CharacterNo#isJavaIdentifierStart(char)
     * @see     CharacterNo#isJavaLetter(char)
     * @see     CharacterNo#isJavaLetterOrDigit(char)
     * @see     CharacterNo#isLetterOrDigit(char)
     * @see     CharacterNo#isLowerCase(char)
     * @see     CharacterNo#isTitleCase(char)
     * @see     CharacterNo#isUnicodeIdentifierStart(char)
     * @see     CharacterNo#isUpperCase(char)
     */
     ...
     *          {@code false} otherwise.
     * @see     CharacterNo#isDigit(int)
     * @see     CharacterNo#isJavaIdentifierStart(int)
     * @see     CharacterNo#isLetterOrDigit(int)
     * @see     CharacterNo#isLowerCase(int)
     * @see     CharacterNo#isTitleCase(int)
     * @see     CharacterNo#isUnicodeIdentifierStart(int)
     * @see     CharacterNo#isUpperCase(int)
     * @since   1.5
     */
    public static boolean isLetter(int codePoint) {
        return ((((1 << CharacterNo.UPPERCASE_LETTER) |
                (1 << CharacterNo.LOWERCASE_LETTER) |
                (1 << CharacterNo.TITLECASE_LETTER) |
                (1 << CharacterNo.MODIFIER_LETTER) |
                (1 << CharacterNo.OTHER_LETTER)) >> getType(codePoint)) & 1)
                != 0;
    }
     ...
     * {@code CharacterNo.isLetter(char ch)} or
     * {@code CharacterNo.isDigit(char ch)} returns
     ...
     *          {@code false} otherwise.
     * @see     CharacterNo#isDigit(char)
     * @see     CharacterNo#isJavaIdentifierPart(char)
     * @see     CharacterNo#isJavaLetter(char)
     * @see     CharacterNo#isJavaLetterOrDigit(char)
     * @see     CharacterNo#isLetter(char)
     * @see     CharacterNo#isUnicodeIdentifierPart(char)
     * @since   1.0.2
     */
     ...
     *          {@code false} otherwise.
     * @see     CharacterNo#isDigit(int)
     * @see     CharacterNo#isJavaIdentifierPart(int)
     * @see     CharacterNo#isLetter(int)
     * @see     CharacterNo#isUnicodeIdentifierPart(int)
     * @since   1.5
     */
    public static boolean isLetterOrDigit(int codePoint) {
        return ((((1 << CharacterNo.UPPERCASE_LETTER) |
                ...
                (1 << CharacterNo.TITLECASE_LETTER) |
                (1 << CharacterNo.MODIFIER_LETTER) |
                (1 << CharacterNo.OTHER_LETTER) |
                (1 << CharacterNo.DECIMAL_DIGIT_NUMBER)) >> getType(codePoint)) & 1)
                != 0;
    }
     ...
     * @see     CharacterNo#isLetterOrDigit(char)
     * @see     CharacterNo#isUnicodeIdentifierPart(char)
     * @see     CharacterNo#isIdentifierIgnorable(char)
     * @since   1.02
     ...
     * provided by {@link CharacterNo#getType(int) getType(codePoint)}, is any of
     * the following:
     * <ul>
    ...
    public static boolean isAlphabetic(int codePoint) {
        return (((((1 << CharacterNo.UPPERCASE_LETTER) |
                ...
                (1 << CharacterNo.MODIFIER_LETTER) |
                (1 << CharacterNo.OTHER_LETTER) |
                (1 << CharacterNo.LETTER_NUMBER)) >> getType(codePoint)) & 1) != 0) ||
     ...
     * @return {@code true} if the character may be part of a
     *          Java identifier; {@code false} otherwise.
     * @see     CharacterNo#isIdentifierIgnorable(int)
     * @see     CharacterNo#isJavaIdentifierStart(int)
     * @see     CharacterNo#isLetterOrDigit(int)
     * @see     CharacterNo#isUnicodeIdentifierPart(int)
     * @see     javax.lang.model.SourceVersion#isIdentifier(CharSequence)
     ...
     * <p>
     * Note that
     * {@code CharacterNo.isLowerCase(CharacterNo.toLowerCase(ch))}
     * does not always return {@code true} for some ranges of
     * characters, particularly those that are symbols or ideographs.
     *
     * <p>In general, {@link String#toLowerCase()} should be used to map
     * characters to lowercase. {@code String} case mapping methods
     * have several benefits over {@code CharacterNo} case mapping methods.
     * {@code String} case mapping methods can perform locale-sensitive
     * mappings, context-sensitive mappings, and 1:M character mappings, whereas
     * the {@code CharacterNo} case mapping methods cannot.
     *
     * <p><b>Note:</b> This method cannot handle <a
     * href="#supplementary"> supplementary characters</a>. To support
     * all Unicode characters, including supplementary characters, use
     ...
     *
     * <p> Note that
     * {@code CharacterNo.isLowerCase(CharacterNo.toLowerCase(codePoint))}
     * does not always return {@code true} for some ranges of
     * characters, particularly those that are symbols or ideographs.
     *
     * <p>In general, {@link String#toLowerCase()} should be used to map
     ...
     * <p>
     * Note that
     * {@code CharacterNo.isUpperCase(CharacterNo.toUpperCase(ch))}
     * does not always return {@code true} for some ranges of
     * characters, particularly those that are symbols or ideographs.
     *
     ...
     *
     * <p>Note that
     * {@code CharacterNo.isUpperCase(CharacterNo.toUpperCase(codePoint))}
     * does not always return {@code true} for some ranges of
     * characters, particularly those that are symbols or ideographs.
     *
     * <p>In general, {@link String#toUpperCase()} should be used to map
     ...
     * <p>
     * Note that
     * {@code CharacterNo.isTitleCase(CharacterNo.toTitleCase(ch))}
     * does not always return {@code true} for some ranges of
     * characters.
     *
     * <p><b>Note:</b> This method cannot handle <a
     ...
     *
     * <p>Note that
     * {@code CharacterNo.isTitleCase(CharacterNo.toTitleCase(codePoint))}
     * does not always return {@code true} for some ranges of
     * characters.
     *
     * @param   codePoint   the character (Unicode code point) to be converted.
     ...
     * @see        CharacterNo#isSpaceChar(char)
     * @see        CharacterNo#isWhitespace(char)
     ...
     * @return  {@code true} if the character is a space character;
     *          {@code false} otherwise.
     * @see     CharacterNo#isWhitespace(int)
     * @since   1.5
     */
    public static boolean isSpaceChar(int codePoint) {
        return ((((1 << CharacterNo.SPACE_SEPARATOR) |
                (1 << CharacterNo.LINE_SEPARATOR) |
                (1 << CharacterNo.PARAGRAPH_SEPARATOR)) >> getType(codePoint)) & 1)
                != 0;
    }
     ...
     * @return  {@code true} if the character is a Java whitespace
     *          character; {@code false} otherwise.
     * @see     CharacterNo#isSpaceChar(int)
     * @since   1.5
     */
     ...
     * @see     CharacterNo#COMBINING_SPACING_MARK
     * @see     CharacterNo#CONNECTOR_PUNCTUATION
     * @see     CharacterNo#CONTROL
     * @see     CharacterNo#CURRENCY_SYMBOL
     * @see     CharacterNo#DASH_PUNCTUATION
     * @see     CharacterNo#DECIMAL_DIGIT_NUMBER
     * @see     CharacterNo#ENCLOSING_MARK
     * @see     CharacterNo#END_PUNCTUATION
     * @see     CharacterNo#FINAL_QUOTE_PUNCTUATION
     * @see     CharacterNo#FORMAT
     * @see     CharacterNo#INITIAL_QUOTE_PUNCTUATION
     * @see     CharacterNo#LETTER_NUMBER
     * @see     CharacterNo#LINE_SEPARATOR
     * @see     CharacterNo#LOWERCASE_LETTER
     * @see     CharacterNo#MATH_SYMBOL
     * @see     CharacterNo#MODIFIER_LETTER
     * @see     CharacterNo#MODIFIER_SYMBOL
     * @see     CharacterNo#NON_SPACING_MARK
     * @see     CharacterNo#OTHER_LETTER
     * @see     CharacterNo#OTHER_NUMBER
     * @see     CharacterNo#OTHER_PUNCTUATION
     * @see     CharacterNo#OTHER_SYMBOL
     * @see     CharacterNo#PARAGRAPH_SEPARATOR
     * @see     CharacterNo#PRIVATE_USE
     * @see     CharacterNo#SPACE_SEPARATOR
     * @see     CharacterNo#START_PUNCTUATION
     * @see     CharacterNo#SURROGATE
     * @see     CharacterNo#TITLECASE_LETTER
     * @see     CharacterNo#UNASSIGNED
     * @see     CharacterNo#UPPERCASE_LETTER
     * @since   1.1
     */
     ...
     * @return  a value of type {@code int} representing the
     *          character's general category.
     * @see     CharacterNo#COMBINING_SPACING_MARK COMBINING_SPACING_MARK
     * @see     CharacterNo#CONNECTOR_PUNCTUATION CONNECTOR_PUNCTUATION
     * @see     CharacterNo#CONTROL CONTROL
     * @see     CharacterNo#CURRENCY_SYMBOL CURRENCY_SYMBOL
     * @see     CharacterNo#DASH_PUNCTUATION DASH_PUNCTUATION
     * @see     CharacterNo#DECIMAL_DIGIT_NUMBER DECIMAL_DIGIT_NUMBER
     * @see     CharacterNo#ENCLOSING_MARK ENCLOSING_MARK
     * @see     CharacterNo#END_PUNCTUATION END_PUNCTUATION
     * @see     CharacterNo#FINAL_QUOTE_PUNCTUATION FINAL_QUOTE_PUNCTUATION
     * @see     CharacterNo#FORMAT FORMAT
     * @see     CharacterNo#INITIAL_QUOTE_PUNCTUATION INITIAL_QUOTE_PUNCTUATION
     * @see     CharacterNo#LETTER_NUMBER LETTER_NUMBER
     * @see     CharacterNo#LINE_SEPARATOR LINE_SEPARATOR
     * @see     CharacterNo#LOWERCASE_LETTER LOWERCASE_LETTER
     * @see     CharacterNo#MATH_SYMBOL MATH_SYMBOL
     * @see     CharacterNo#MODIFIER_LETTER MODIFIER_LETTER
     * @see     CharacterNo#MODIFIER_SYMBOL MODIFIER_SYMBOL
     * @see     CharacterNo#NON_SPACING_MARK NON_SPACING_MARK
     * @see     CharacterNo#OTHER_LETTER OTHER_LETTER
     * @see     CharacterNo#OTHER_NUMBER OTHER_NUMBER
     * @see     CharacterNo#OTHER_PUNCTUATION OTHER_PUNCTUATION
     * @see     CharacterNo#OTHER_SYMBOL OTHER_SYMBOL
     * @see     CharacterNo#PARAGRAPH_SEPARATOR PARAGRAPH_SEPARATOR
     * @see     CharacterNo#PRIVATE_USE PRIVATE_USE
     * @see     CharacterNo#SPACE_SEPARATOR SPACE_SEPARATOR
     * @see     CharacterNo#START_PUNCTUATION START_PUNCTUATION
     * @see     CharacterNo#SURROGATE SURROGATE
     * @see     CharacterNo#TITLECASE_LETTER TITLECASE_LETTER
     * @see     CharacterNo#UNASSIGNED UNASSIGNED
     * @see     CharacterNo#UPPERCASE_LETTER UPPERCASE_LETTER
     * @since   1.5
     */
     ...
     * @see     CharacterNo#MIN_RADIX
     * @see     CharacterNo#MAX_RADIX
     * @see     CharacterNo#digit(char, int)
     */
    public static char forDigit(int digit, int radix) {
        ...
        if ((radix < CharacterNo.MIN_RADIX) || (radix > CharacterNo.MAX_RADIX)) {
            return '\0';
        }
        if (digit < 10) {
            return (char)('0' + digit);
     ...
     * character.  CharacterNo directionality is used to calculate the
     ...
     *
     * @see CharacterNo#DIRECTIONALITY_UNDEFINED
     * @see CharacterNo#DIRECTIONALITY_LEFT_TO_RIGHT
     * @see CharacterNo#DIRECTIONALITY_RIGHT_TO_LEFT
     * @see CharacterNo#DIRECTIONALITY_RIGHT_TO_LEFT_ARABIC
     * @see CharacterNo#DIRECTIONALITY_EUROPEAN_NUMBER
     * @see CharacterNo#DIRECTIONALITY_EUROPEAN_NUMBER_SEPARATOR
     * @see CharacterNo#DIRECTIONALITY_EUROPEAN_NUMBER_TERMINATOR
     * @see CharacterNo#DIRECTIONALITY_ARABIC_NUMBER
     * @see CharacterNo#DIRECTIONALITY_COMMON_NUMBER_SEPARATOR
     * @see CharacterNo#DIRECTIONALITY_NONSPACING_MARK
     * @see CharacterNo#DIRECTIONALITY_BOUNDARY_NEUTRAL
     * @see CharacterNo#DIRECTIONALITY_PARAGRAPH_SEPARATOR
     * @see CharacterNo#DIRECTIONALITY_SEGMENT_SEPARATOR
     * @see CharacterNo#DIRECTIONALITY_WHITESPACE
     * @see CharacterNo#DIRECTIONALITY_OTHER_NEUTRALS
     * @see CharacterNo#DIRECTIONALITY_LEFT_TO_RIGHT_EMBEDDING
     * @see CharacterNo#DIRECTIONALITY_LEFT_TO_RIGHT_OVERRIDE
     * @see CharacterNo#DIRECTIONALITY_RIGHT_TO_LEFT_EMBEDDING
     * @see CharacterNo#DIRECTIONALITY_RIGHT_TO_LEFT_OVERRIDE
     * @see CharacterNo#DIRECTIONALITY_POP_DIRECTIONAL_FORMAT
     * @since 1.4
     */
    ...
    /**
     * Returns the Unicode directionality property for the given
     * character (Unicode code point).  CharacterNo directionality is
     ...
     *
     * @see CharacterNo#DIRECTIONALITY_UNDEFINED DIRECTIONALITY_UNDEFINED
     * @see CharacterNo#DIRECTIONALITY_LEFT_TO_RIGHT DIRECTIONALITY_LEFT_TO_RIGHT
     * @see CharacterNo#DIRECTIONALITY_RIGHT_TO_LEFT DIRECTIONALITY_RIGHT_TO_LEFT
     * @see CharacterNo#DIRECTIONALITY_RIGHT_TO_LEFT_ARABIC DIRECTIONALITY_RIGHT_TO_LEFT_ARABIC
     * @see CharacterNo#DIRECTIONALITY_EUROPEAN_NUMBER DIRECTIONALITY_EUROPEAN_NUMBER
     * @see CharacterNo#DIRECTIONALITY_EUROPEAN_NUMBER_SEPARATOR DIRECTIONALITY_EUROPEAN_NUMBER_SEPARATOR
     * @see CharacterNo#DIRECTIONALITY_EUROPEAN_NUMBER_TERMINATOR DIRECTIONALITY_EUROPEAN_NUMBER_TERMINATOR
     * @see CharacterNo#DIRECTIONALITY_ARABIC_NUMBER DIRECTIONALITY_ARABIC_NUMBER
     * @see CharacterNo#DIRECTIONALITY_COMMON_NUMBER_SEPARATOR DIRECTIONALITY_COMMON_NUMBER_SEPARATOR
     * @see CharacterNo#DIRECTIONALITY_NONSPACING_MARK DIRECTIONALITY_NONSPACING_MARK
     * @see CharacterNo#DIRECTIONALITY_BOUNDARY_NEUTRAL DIRECTIONALITY_BOUNDARY_NEUTRAL
     * @see CharacterNo#DIRECTIONALITY_PARAGRAPH_SEPARATOR DIRECTIONALITY_PARAGRAPH_SEPARATOR
     * @see CharacterNo#DIRECTIONALITY_SEGMENT_SEPARATOR DIRECTIONALITY_SEGMENT_SEPARATOR
     * @see CharacterNo#DIRECTIONALITY_WHITESPACE DIRECTIONALITY_WHITESPACE
     * @see CharacterNo#DIRECTIONALITY_OTHER_NEUTRALS DIRECTIONALITY_OTHER_NEUTRALS
     * @see CharacterNo#DIRECTIONALITY_LEFT_TO_RIGHT_EMBEDDING DIRECTIONALITY_LEFT_TO_RIGHT_EMBEDDING
     * @see CharacterNo#DIRECTIONALITY_LEFT_TO_RIGHT_OVERRIDE DIRECTIONALITY_LEFT_TO_RIGHT_OVERRIDE
     * @see CharacterNo#DIRECTIONALITY_RIGHT_TO_LEFT_EMBEDDING DIRECTIONALITY_RIGHT_TO_LEFT_EMBEDDING
     * @see CharacterNo#DIRECTIONALITY_RIGHT_TO_LEFT_OVERRIDE DIRECTIONALITY_RIGHT_TO_LEFT_OVERRIDE
     * @see CharacterNo#DIRECTIONALITY_POP_DIRECTIONAL_FORMAT DIRECTIONALITY_POP_DIRECTIONAL_FORMAT
     * @since    1.5
     */
    ...
    /**
     * Compares two {@code CharacterNo} objects numerically.
     *
     * @param   anotherCharacter   the {@code CharacterNo} to be compared.

     * @return  the value {@code 0} if the argument {@code CharacterNo}
     *          is equal to this {@code CharacterNo}; a value less than
     *          {@code 0} if this {@code CharacterNo} is numerically less
     *          than the {@code CharacterNo} argument; and a value greater than
     *          {@code 0} if this {@code CharacterNo} is numerically greater
     *          than the {@code CharacterNo} argument (unsigned comparison).
     *          Note that this is strictly a numerical comparison; it is not
     *          locale-dependent.
     * @since   1.2
     */
    public int compareTo(CharacterNo anotherCharacter) {
     ...
     * <pre>
     *    CharacterNo.valueOf(x).compareTo(CharacterNo.valueOf(y))
     * </pre>
     *
     ...
     *          any, or an error flag ({@code CharacterNo.ERROR})
     ...
     * the <i>UnicodeData</i> file (part of the Unicode CharacterNo
     * Database maintained by the Unicode Consortium), the returned
     * name is the same as the result of expression.
     *
     * <blockquote>{@code
     *     CharacterNo.UnicodeBlock.of(codePoint).toString().replace('_', ' ')
     *     + " "
