...
/**
 * Interface to a concurrent representation of a ship that can move around a 2
 * dimensional space with updates and reads performed concurrently.
 */
interface Spaceship {
	/**
	 ...
	 *
	 * @param coordinates
	 *            into which the x and y coordinates should be read.
	 ...
	 *
	 * @param xDelta
	 *            delta by which the spaceship should be moved in the x-axis.
	 * @param yDelta
	 *            delta by which the spaceship should be moved in the y-axis.
